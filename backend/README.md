...
## Project Structure
    ...
    ├── testapiautosetting_123655  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123655`
...
2. Clone this repo and `cd testapiautosetting_123655`
